    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-4 md:p-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6 flex justify-between items-center">
          ...
          {activeTab === "profile" && <button className='bg-purple-600 text-white p-4 rounded cursor-pointer'
            onClick={() => handleSubmit(profile)} >Profile save
          </button>}
        </div>
            ...
            <nav className="flex px-6">
              {tabs.map((tab) => (
                <button
                  ...
                  className={`py-4 px-6 cursor-pointer border-b-2 font-medium text-sm flex items-center gap-3 transition-all duration-200 ${activeTab === tab.id
            ...
            {activeTab === 'profile' && (
              <div className="flex gap-8 ">
                ...
                <div className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-2xl p-6 border border-purple-100 lg:w-[24rem] space-y-8">
                  <h4 className="text-lg font-semibold text-gray-900 mb-4">Profile Preview</h4>
                  ...
                  <div className="mt-4 text-sm space-y-4">
                    ...
                    {profileData.isActive === true && <p><span className="font-medium">Account Status:</span> Active</p>}
                    <p><span className="font-medium">Created:</span> {profileData?.createdAt}</p>
                  </div>
                </div>
